...
public class ABloomFilter implements IBloomFilter {

    private int size;
    private int k;
    private int nbElement;
    private ArrayList<Integer> myBits;

    public ABloomFilter(int nbElement, int size, int k){
        this.nbElement = nbElement;
        this.size = (int)(size*nbElement)/100;
        this.k = k;
        this.myBits = new ArrayList<>(); 
     ...
     */
    public static ABloomFilter bloomFilterWithElement(int nbElement, int size, int k){
        ABloomFilter bloomFilter = new ABloomFilter(nbElement, size, k);
        Random r = new Random();
